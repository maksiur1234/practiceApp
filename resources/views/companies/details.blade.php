...
<head>
    ...
    <title>Calendar click to add event</title>
...
<div class="container mt-5" style="max-width: 700px">
    <h2 class="h2 text-center mb-5 border-bottom pb-3">Laravel FullCalendar CRUD Events Example</h2>
                ...
                if (event_name) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            calendar.fullCalendar('refetchEvents'); // Dodaj tę linię
                        }
                    });
                }
            },
